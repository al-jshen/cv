...
% margins
\usepackage[a4paper,top=0.3in, bottom=0.3in, left=1in, right=1in]{geometry}
% font
...
% \textbf{Data}: Stan, Pyro, NumPy, SciPy, Pandas, PyTorch, Scikit-Learn, Matplotlib, SQL, R \\
% \textbf{Other}: Rust, BLAS/LAPACK, Astropy, \LaTeX, regex, bash, git, Docker, AWS, SymPy
