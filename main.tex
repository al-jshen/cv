...
\begin{xltabular}{\textwidth}{lX}
  ...
  2020 Aug - Present & \textbf{Estimating the mass of the Galaxy with Bayesian hierarchical models} \\*
                      ...
                      & Undergraduate fellowship with CITA. Developed a hierarchical Bayesian model for modelling the mass of the Galaxy using a fast and scalable sampling algorithm. Collaborated with the \href{http://h3survey.rc.fas.harvard.edu/}{H3 Survey} team and submitted a paper to ApJ. \\
