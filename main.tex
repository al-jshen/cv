...
\begin{etaremune}
\item \textbf{Jeff Shen}, Gwendolyn M. Eadie, Norman Murray, Dennis Zaritsky, Joshua S. Speagle, et al. ``Estimating the Mass Distribution of the Milky Way with Bayesian Multilevel Models, the No-U-Turn Sampler, and Halo Stars from the H3 Survey'', in prep.
...
\begin{tabularx}{\textwidth}{lX}
  ...
  2021 May & \textbf{Canadian Astronomical Society (CASCA) AGM, Online} \\
...
\begin{tabularx}{\textwidth}{lX}
  2021 Jul & \textbf{National Ratio Astronomy Organization (NRAO) eNews} \\
           & Digital newsletter feature: ``Molecular gas in high redshift galaxies'', \textbf{Jeff Shen} and Allison Man. \url{https://science.nrao.edu/enews/14.7} \\
\end{tabularx}
