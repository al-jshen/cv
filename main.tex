...
% margins
\usepackage[letterpaper,top=0.3in, bottom=0.75in, left=0.9in, right=0.9in]{geometry}
% font
...
Majors in Astronomy \& Astrophysics and Statistics. Minor in Mathematics. 
...
\begin{xltabular}{\textwidth}{lX}
  2021 Jan - 2021 May & \textbf{Dean's List Scholar} \\*
