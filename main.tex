...
\textbf{H.B.Sc.}, University of Toronto (Astronomy \& Astrophysics, Statistics, Mathematics) \hfill 2018-2022 
...
\begin{xltabular}{\textwidth}{lX}
  2021 May - 2021 Aug & \textbf{Undergraduate Summer Research Fellowship} \\*
                      ...
                      & Supervisors: \href{https://www.astro.utoronto.ca/~eadie/cover.html}{Prof. Gwendolyn Eadie}, \href{https://www.cita.utoronto.ca/~murray/}{Prof. Norman Murray}, \href{https://joshspeagle.github.io/}{Dr. Josh Speagle} \\
                      & Continued previous work on the mass distribution of the Milky Way. Collaborated with members of the \href{http://h3survey.rc.fas.harvard.edu/}{H3 Survey} and published a first-author paper in ApJ. Began a project using normalizing flows to make probabilistic predictions of the ages of stars and a project using Stan to fit dynamical models to geological data from thermal tides. \\
  ...
  2020 May - 2020 Aug & \textbf{Summer Undergraduate Research Program} \\*
                      ...
                      & Analyzed ALMA data to infer molecular gas masses in several high-redshift galaxies. Resulted in a first-author publication.
\end{xltabular}
...
\begin{xltabular}{\textwidth}{lX}
  2021 & Comprehensive scientific computing package for Rust: SIMD-accelerated linear algebra, statistical distributions, numerical optimization, linear models, and more. \url{github.com/al-jshen/compute} \\
  2021 & Zero-dependency reverse-mode automatic differentiation package. \url{github.com/al-jshen/reverse} \\
  2021 & Fast and easy random number generation in Rust with Wyrand. \url{github.com/al-jshen/alea} \\
  2020 & Parallelized ray tracer for realistic scene rendering. \url{github.com/al-jshen/traycer} \\
...
\textbf{Other}: Rust, BLAS/LAPACK, SIMD intrinsics, Astropy, \LaTeX, regex, bash, git, Docker, AWS, Javascript, React
